...
export 'pip_platform_interface.dart'
    show PipOptions, PipStateChangedObserver, PipState, PipViewSizeCallback;

class Pip {
  /// 若不为 null，收到原生上报的 PipView 宽高时会调用（仅 iOS）。
  static PipViewSizeCallback? get onPipViewSizeReported =>
      PipPlatform.onPipViewSizeReported;
  static set onPipViewSizeReported(PipViewSizeCallback? v) {
    PipPlatform.onPipViewSizeReported = v;
  }
